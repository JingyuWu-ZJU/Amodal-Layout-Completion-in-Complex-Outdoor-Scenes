...
class SingleStageModel(object):
    def __init__(self, params, dist_model=False):   
        self.model = backbone.__dict__['unet2'](in_channels=params['in_ch'],n_classes=params['num_cls'])
    ...
    def save_state(self, path, Iter, epoch):
        path = os.path.join(path, "{}_{}.pth.tar".format(epoch,Iter))
